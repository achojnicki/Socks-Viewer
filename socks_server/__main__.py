...
class Server(ThreadingMixIn, TCPServer):
    def __init__(self, *args, **kwargs):
        self._config=kwargs['adisconfig']
        del kwargs['adisconfig']
        ...
        print(f'Starting socks server at {self._config.socks.host}:{self._config.socks.port}')
...
if __name__ == '__main__':
    config=adisconfig('./configs/socks_server.yaml')
    with Server((config.socks.host, config.socks.port), SocksProxy, adisconfig=config) as server:
